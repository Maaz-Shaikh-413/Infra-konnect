                        ...
                        <ul>
                           ...
                           <li class="has-dropdown">
                              ...
                              <ul class="submenu tp-submenu">
                                 ...
                                 <li><a href="client_dashboard.php">Contact 0222</a></li>
               ...
               <div class="col-12">
                  <div class="tp-category-wrap">
                     <div class="tp-category-slider-active">
                        ...
                        <div class="tp-category-main">
                           <div class="tp-category-item-wrap">
                              <a href="Buy-Drone-Parts.html" class="tp-category-item d-flex align-items-center">
                                 <div class="tp-category-thumb">
                        ...
                        <div class="tp-category-main">
                           <div class="tp-category-item-wrap">
                              <a href="Sell-parts-Manu.html" class="tp-category-item d-flex align-items-center">
                                 <div class="tp-category-thumb">
                                    <img src="assets/img/category/category-sm-1-2.png" alt="">
                                 </div>
                                 <div class="tp-category-content">
                        ...
                        <div class="tp-category-main">
                           <div class="tp-category-item-wrap">
                              <a href="indian_drone_companies_page.html" class="tp-category-item d-flex align-items-center">
                                 <div class="tp-category-thumb">
                                    <img src="assets/img/category/category-sm-1-2.png" alt="">
                                 </div>
                                 <div class="tp-category-content">
                        ...
                        <div class="tp-category-main">
                           <div class="tp-category-item-wrap">
                              <a href="india_guide_page.html" class="tp-category-item d-flex align-items-center">
                                 <div class="tp-category-thumb">
         ...
         <div class="container">
            <div class="row align-items-center">
               ...
               <div class="col-xl-5 col-lg-5">
                  <div class="tp-hero-thumb-wrap p-relative d-flex justify-content-lg-between justify-content-center">
                     ...
                     <div class="tp-hero-thumb-box">
                        <div class="tp-hero-thumb-2 fix p-relative mb-10">
                           ...
                           <div class="tp-hero-thumb-text">
                              <h6><i class="purecounter" data-purecounter-duration="1" data-purecounter-end="5000">0</i>
                                 +</h6>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       <div class="tp-location-thumb">
                                          <img src="assets/img/Services/Aerial Photography & Videography.jpg" alt="">
                                       </div>
                                       <div class="tp-location-thumb-text">
                                       
                                          <h4 class="tp-location-title"><a href="Arieal-details.html">Aerial Photography & Videography</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="Agri-details.html">Agriculture</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="Disaster-details.html">Disaster Management</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="healthcare-details.html">Healthcare</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="Livestock-details.html">Livestock Management</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="Logistic-details.html">Logistics</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="Survey-details.html">Survey & Mapping</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       <div class="tp-location-thumb">
                                          <img src="assets/img/Services/UAV Engineering Consultancy.jpg" alt="">
                                       </div>
                                       <div class="tp-location-thumb-text">
                                          <span>366+ listing</span>
                                          <h4 class="tp-location-title"><a href="UAV-details.html">UAV Engineering Consultancy</a></h4>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="listing-grid.html">Dhaka</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="listing-grid.html">Mumbai</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          <span>230+ ads</span>
                                          <h4 class="tp-location-title"><a href="listing-grid.html">Tokyo</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="listing-grid.html">Bangkok</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          ...
                                          <h4 class="tp-location-title"><a href="listing-grid.html">Hanoi</a></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
                                    <div class="tp-location-thumb-box p-relative">
                                       ...
                                       <div class="tp-location-thumb-text">
                                          <span>366+ listing</span>
                                          <h4 class="tp-location-title"><a href="listing-grid.html">Astoi</a></h4>
                                       </div>
                                    </div>
                                 </div>
                              </div>
            ...
            <div class="row">
                  ...
                  <div class="tp-listing-item">
                     <div class="tp-listing-figure p-relative">
                        <div class="tp-listing-thumbnail">
                           <a href="listing-details-1.html"><img src="assets/img/listing/listing-1-1.jpg" alt=""></a>
                        </div>
                     ...
                     <div class="tp-listing-content-box">
                        ...
                        <div class="tp-listing-bottom-metas d-flex justify-content-between">
                           ...
                           <div class="tp-listing-details-box">
                              <a href="listing-details-1.html">Details <i class="fa-regular fa-angle-right"></i></a>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30  wow tpfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="tp-listing-item">
                     <div class="tp-listing-figure p-relative">
                        <div class="tp-listing-thumbnail">
                           <a href="listing-details-1.html"><img src="assets/img/listing/listing-1-2.jpg" alt=""></a>
                        </div>
                        <div class="tp-listing-avatar-box">
                           <ul>
                              <li>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30  wow tpfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="tp-listing-item">
                     <div class="tp-listing-figure p-relative">
                        <div class="tp-listing-thumbnail">
                           <a href="listing-details-1.html"><img src="assets/img/listing/listing-1-8.jpg" alt=""></a>
                        </div>
                        <div class="tp-listing-avatar-box">
                           <ul>
                              <li>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30  wow tpfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="tp-listing-item">
                     <div class="tp-listing-figure p-relative">
                        <div class="tp-listing-thumbnail">
                           <a href="listing-details-1.html"><img src="assets/img/listing/listing-1-3.jpg" alt=""></a>
                        </div>
                        <div class="tp-listing-avatar-box">
                           <ul>
                              <li>
                     ...
                     <div class="tp-listing-content-box">
                        ...
                        <h4 class="tp-listing-title"><a href="Kisan-Agri-Details.html">Kisan Agri Drone V.1</a></h4>
                        <div class="tp-listing-location">
                           <span><i class="fa-light fa-check"></i> Verified</span>
                           <span><i class="fa-light fa-location-dot"></i> India</span>
                        </div>
                           ...
                           <div class="swiper-slide">
                              <div class="tp-category-2-item p-relative">
                                 <div class="tp-category-2-thumb">
                                    <img src="assets/img/training/UAV Simulator Training.jpg" alt="">
                                 </div>
                                 <div class="tp-category-2-content">
                                    ...
                                    <h4 class="tp-category-2-title"><a href="UAV-Training.html"> UAV Simulator Training</a></h4>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-category-2-item p-relative">
                                 ...
                                 <div class="tp-category-2-content">
                                    ...
                                    <h4 class="tp-category-2-title"><a href="UAV-Course.html">UAV Technician Course</a></h4>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-category-2-item p-relative">
                                 <div class="tp-category-2-thumb">
                                    <img src="assets/img/training/UAV Maintainance & Repair Course.jpg" alt="">
                                 </div>
                                 <div class="tp-category-2-content">
                                    <div class="tp-category-2-icon">
                                       <span>
                                    ...
                                    <h4 class="tp-category-2-title"><a href="UAV-repair.html">UAV Maintainance & Repair Course</a></h4>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-category-2-item p-relative">
                                 ...
                                 <div class="tp-category-2-content">
                                    ...
                                    <h4 class="tp-category-2-title"><a href="Drone-Building.html">Drone Building Course</a></h4>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                            <div class="tp-category-2-item p-relative">
                               ...
                               <div class="tp-category-2-content">
                                  ...
                                  <h4 class="tp-category-2-title"><a href="UAV-Data.html">UAV Data Processing</a></h4>
                               </div>
                            </div>
                           </div>
                            <div class="swiper-slide">
                                <div class="tp-category-2-item p-relative">
                                   <div class="tp-category-2-thumb">
                                      <img src="assets/img/training/Aerial Cinema & Film Making.jpg" alt="">
                                   </div>
                                   <div class="tp-category-2-content">
                                      <div class="tp-category-2-icon">
                                         <span>
                                      ...
                                      <h4 class="tp-category-2-title"><a href="Aerial-training.html">Aerial Cinematography And Film Making</a></h4>
                                   </div>
                                </div>
                            </div>
                             ...
                             <div class="swiper-slide">
                                <div class="tp-category-2-item p-relative">
                                   ...
                                   <div class="tp-category-2-content">
                                      ...
                                      <h4 class="tp-category-2-title"><a href="UAV-Applications.html">UAV Industrial Applications</a></h4>
                                   </div>
                                </div>
                             </div>
                             <div class="swiper-slide">
                                <div class="tp-category-2-item p-relative">
                                   <div class="tp-category-2-thumb">
                                      <img src="assets/img/training/Software codes for UAV appln.jpg" alt="">
                                   </div>
                                   <div class="tp-category-2-content">
                                      <div class="tp-category-2-icon">
                                         <span>
                                      ...
                                      <h4 class="tp-category-2-title"><a href="Software-Codes.html">Software Codes For UAV Applications</a></h4>
                                   </div>
                                </div>
                             </div>
            ...
            <div class="col mb-30">
               <a href="Material-reconciling.html">
                  <div class="tp-category-3-item d-flex align-items-center justify-content-between">
                     ...
                     <div class="tp-category-3-icon">
                        <span>
                           <img src="assets/img/Category Icon/Material reconciling.png" width="50px">
                        </span>
                     </div>
                  </div>
               </a>
                           ...
                           <div class="swiper-slide">
                              <div class="tp-testimonial-item p-relative d-flex align-items-start">
                                 ...
                                 <div class="tp-testimonial-content">
                                    ...
                                    <div class="tp-testimonial-text pb-10">
                                       <p>“ Providing false information about a product can harm both consumers and
                                          manufacturers. ”</p>
                                    </div>
                                    <div class="tp-testimonial-author-info">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                  <div class="tp-blog-item">
                     ...
                     <div class="tp-blog-content">
                        ...
                        <h4 class="tp-blog-title"><a class="text-anim" href="blog-details.html">The website is well-organized, &
                              making it easy to discover...</a></h4>
                        <div class="tp-blog-link-box d-flex justify-content-between">
                           <div class="tp-blog-link">
                              <a href="blog-details.html"><i class="fa-light fa-arrow-right-long"></i>Read More</a>
                           </div>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                  <div class="tp-blog-item">
                     ...
                     <div class="tp-blog-content">
                        ...
                        <h4 class="tp-blog-title"><a class="text-anim" href="blog-details.html">If you have concerns about a product or
                              want...</a></h4>
                        <div class="tp-blog-link-box d-flex justify-content-between">
                           <div class="tp-blog-link">
                              <a href="blog-details.html"><i class="fa-light fa-arrow-right-long"></i>Read More</a>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                  <div class="tp-blog-item">
                     ...
                     <div class="tp-blog-content">
                        ...
                        <h4 class="tp-blog-title"><a class="text-anim" href="blog-details.html">To share your experiences, it's best to
